module.exports = `$primary-color: #203850;
$secondary-color: #bbb;
$dark-color: #1d1d1d;
$success-color: #26af70;
$danger-color: red;
...
$primary-box-shadow: 0 0 6px #000;

// Media Queries
$mq-400-down: "only screen and (max-width: 399px)";
$mq-400-up: "only screen and (min-width: 400px)";

$mq-620-down: "only screen and (max-width: 619px)";
...
$mq-1180-down: "only screen and (max-width: 1179px)";
$mq-1180-up: "only screen and (min-width: 1180px)";

$mq-1400-dow: "only screen and (max-width: 1399px)";
